...
const CreateBatch = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-8">
      {/* Back Button */}
      <Link to="/admin/batches" className="flex items-center text-blue-600 hover:underline mb-4">
      ...
      <div className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-xl shadow-sm p-6 sm:p-8">
        <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Create New Batch</h2>
