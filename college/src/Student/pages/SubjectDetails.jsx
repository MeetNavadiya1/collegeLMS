  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-6 px-4">
      <div className="mx-auto">
        ...
        <h1 className="mt-8 text-xl font-bold mb-6 text-gray-800">Subject Details</h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
          {cardData.map((card, index) => (
            ...
            >
              ...
              <div className="flex justify-end flex-col pr-2 pl-2 py-3 text-center">
                <h2 className="text-md font-semibold text-gray-800">{card.label}</h2>
                <Link to={card.link} className='text-sm text-blue-500 mt-2 hover:underline'>View {card.label}</Link>
              </div>
            </div>
          ))}
        </div>
