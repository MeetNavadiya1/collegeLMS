...
const mockSubmissions = [
  {
    id: 1,
    name: 'Kunal Desai',
    enrollment: '2023MCA101',
    submittedAt: '2025-06-10',
    fileUrl: '/files/project1.pdf',
    feedback: 'Excellent use of modular design.',
  },
  {
    id: 2,
    name: 'Sneha Mehta',
    enrollment: '2023MCA102',
    submittedAt: '2025-06-11',
    fileUrl: '/files/project2.pdf',
    feedback: 'Good effort but lacks documentation.',
  },
];
...
const ProjectSubmissions = () => {
  ...
  const handleAIButton = (id) => {
    setFeedbacks((prev) => ({
      ...prev,
      [id]: prev[id] + ' [AI generated feedback here]',
    }));
  };
        ...
        <table className="min-w-[1100px] w-full text-sm text-left text-gray-700">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-2 py-2 w-40">Submitted Project</th>
